...
<span style="color: rgb(255, 76, 65);">**⚠️特别提示:** </span> 请先下载本教程需要用到的Mixly资料(包含： Mixly代码和库文件等）等，保存至您方便使用的路径下。
...
<span style="background: rgb(255, 251, 0);">**下载链接：**</span> [https://pan.baidu.com/s/1sV0DUDKg7OiQcKyIkBI1Ew?pwd=keye](https://pan.baidu.com/s/1sV0DUDKg7OiQcKyIkBI1Ew?pwd=keye) 

<span style="background: rgb(255, 251, 0);">**提取码：**</span> keye 
...
<span style="color: rgb(255, 76, 65);">Mixly For Linux(根据系统选择)：</span>

![Img](./media/img-20250613164054.png)
...
![Img](./media/img-20250618100945.png)

**MAC版本安装：**

提供有MAC安装Mixly2.0.txt的文本，安装时可以参考里面的安装方法。

![Img](./media/img-20250613164733.png)

**Linux版本安装：**

提供有Linux安装Mixly2.0.txt的文本，安装时可以参考里面的安装方法。

![Img](./media/img-20250613164814.png)
...
3\. ESP32 Plus控制板类型和端口选好后，您也可以双击或者单击“打开”按钮来打开示例代码程序“Yellow LED Blinking”（此示例代码存放的路径：**..\Mixly资料\Mixly_代码**），按照以下步骤操作。
...
怎么上传代码，请点击链接：[Mixly IDE的使用方法](https://www.keyesrobot.cn/projects/KE3050/zh-cn/latest/docs/Mixly%20%E6%95%99%E7%A8%8B.html#id9) 跳转到对应位置查看。
...
![Img](./media/img-20250605163047.png)

**1.7. 实验结果：**

上传测试代码成功，上电后，如果成功连接上WiFi，LCD1602 显示分配到的IP地址，同时在串口监视器点击![Img](./media/img-20250605164302.png)设置波特率为9600，串口监视器会打印出分配到的IP地址。（假如串口监视器没打印出分配到的IP地址，可以按下主板上的复位键重启)
...
APP输入IP地址（LCD1602显示出分配到的IP地址或在串口监视器点击![Img](./media/img-20250605164302.png)设置波特率为9600，串口监视器会打印出分配到的IP地址），点击 **CONNECT** 连接，连接成功标志是APP下方会跳出 Connected，需要注意看.
...
A. APP输入IP地址（LCD1602显示出分配到的IP地址，或点击IDE的串口监视器![Img](./media/img-20250605164302.png)，串口监视器窗口显示的IP地址）
